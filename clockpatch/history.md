...
- **700015-005** (C-Lab MK X, sometimes without the 00X suffix)
...
2. **Colour encoding**: Early falcons from B3 and B5 follow the rules and include the number indicating colour encoding in their serial number. All of the Y4 Falcons except the 12/1993 Peritel batch however skip this number and rely solely on the PCB production number (ironically, the Peritel batch has got the PCB production number wrong).
3. **Sequential numbering**: It's more or less clear that every factory used its own numbers and there were several numbering resets during the production.
...
5. Fifth batch happend in 06-07/1993 in **B3** (s/n numbering reset)
6. Sixth (Peritel only?) batch happend in 12/1993 in **Y4** (s/n numbering reset)
7. Seventh batch happend in 01/1994 in **Y4** (s/n numbering reset)
8. Eighth batch happened in 09/1994 in **Y4** for C-Lab MK II (and maybe MK X) models (s/n numbering reset). Interestingly, one can find PCBs with the old production number (Atari's) as well as the new one (C-Lab's) from this very same month.
9. Nineth and the last batch in 12/1995 in **Y4** for C-Lab MK X models (s/n numbering reset)
...
- B5: 29 (08/1992) + 1255 (02/1993)
- B3: 402 (02/1993) + 192 (04/1993) + 291 (06-07/1993)
- Y4: 3015 (12/1992-02/1993) + 11903 (03-09/1993) + 4786 (12/1993) + 311 (01/1994) + 1477 (09/1994) + 211 (12/1995)

That gives us **22,184** known original Falcon030 units and **1,688** known C-Lab units. Therefore it's safe to assume the number isn't much higher than 20,000.
